function CodeDefine() { 
this.def = new Array();
this.def["PIDC_DW"] = {file: "PIDC_c.html",line:35,type:"var"};
this.def["PIDC_U"] = {file: "PIDC_c.html",line:38,type:"var"};
this.def["PIDC_Y"] = {file: "PIDC_c.html",line:41,type:"var"};
this.def["PIDC.c:PIDC_M_"] = {file: "PIDC_c.html",line:44,type:"var"};
this.def["PIDC_M"] = {file: "PIDC_c.html",line:45,type:"var"};
this.def["PIDC_step"] = {file: "PIDC_c.html",line:48,type:"fcn"};
this.def["PIDC_initialize"] = {file: "PIDC_c.html",line:211,type:"fcn"};
this.def["DW_PIDC"] = {file: "PIDC_h.html",line:62,type:"type"};
this.def["ExtU_PIDC"] = {file: "PIDC_h.html",line:78,type:"type"};
this.def["ExtY_PIDC"] = {file: "PIDC_h.html",line:84,type:"type"};
this.def["RT_MODEL_PIDC"] = {file: "PIDC_types_h.html",line:37,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["PIDC_c.html"] = "../PIDC.c";
	this.html2Root["PIDC_c.html"] = "PIDC_c.html";
	this.html2SrcPath["PIDC_h.html"] = "../PIDC.h";
	this.html2Root["PIDC_h.html"] = "PIDC_h.html";
	this.html2SrcPath["PIDC_private_h.html"] = "../PIDC_private.h";
	this.html2Root["PIDC_private_h.html"] = "PIDC_private_h.html";
	this.html2SrcPath["PIDC_types_h.html"] = "../PIDC_types.h";
	this.html2Root["PIDC_types_h.html"] = "PIDC_types_h.html";
	...
	this.html2SrcPath["PIDC_External_Functions_h.html"] = "../PIDC_External_Functions.h";
	this.html2Root["PIDC_External_Functions_h.html"] = "PIDC_External_Functions_h.html";
...
var fileList = [
"PIDC_c.html","PIDC_h.html","PIDC_private_h.html","PIDC_types_h.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html","PIDC_External_Functions_h.html","STM32_Config_h.html","main_c.html","stm32xxxx_it_c.html"];
